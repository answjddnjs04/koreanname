...
const questions = [
    {
        ...
        imageA: "https://via.placeholder.com/600x400?text=Squid+Game",
        imageB: "https://via.placeholder.com/600x400?text=Chaebol+Family",
    ...
    },
    {
        ...
        imageA: "https://via.placeholder.com/600x400?text=Crash+Landing",
        imageB: "https://via.placeholder.com/600x400?text=Business+Proposal",
    ...
    },
    {
        ...
        imageA: "https://via.placeholder.com/600x400?text=Zombie+Apocalypse",
        imageB: "https://via.placeholder.com/600x400?text=Bloodhounds",
    ...
    },
    {
        ...
        imageA: "https://via.placeholder.com/600x400?text=Queen+of+Tears+End",
        imageB: "https://via.placeholder.com/600x400?text=CLOY+End",
    ...
    },
    {
        ...
        imageA: "https://via.placeholder.com/600x400?text=Front+Man",
        imageB: "https://via.placeholder.com/600x400?text=The+Glory",
    ...
    },
    {
        ...
        imageA: "https://via.placeholder.com/600x400?text=Attorney+Woo",
        imageB: "https://via.placeholder.com/600x400?text=Doctor+Slump",
    ...
    },
    {
        ...
        imageA: "https://via.placeholder.com/600x400?text=Physical+100",
        imageB: "https://via.placeholder.com/600x400?text=Culinary+Class+Wars",
    ...
    },
    {
        ...
        imageA: "https://via.placeholder.com/600x400?text=Red+Light+Green+Light",
        imageB: "https://via.placeholder.com/600x400?text=Human+vs+Zombie",
    ...
    },
    {
        ...
        imageA: "https://via.placeholder.com/600x400?text=Hyun-woo+Hae-in",
        imageB: "https://via.placeholder.com/600x400?text=Tangerines",
    ...
    },
    {
        ...
        imageA: "https://via.placeholder.com/600x400?text=King+the+Land",
        imageB: "https://via.placeholder.com/600x400?text=Boyfriend+on+Demand",
